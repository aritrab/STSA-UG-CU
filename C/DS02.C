...
main ()
{
/*                       Calculating correlation coefficient using C                          */

/* INPUTTING THE DATA SET */

	int i,j,n;
	double a[30],b[30],c,sum1,ssq1,sum2,ssq2,avg1,avg2,var1,sd1,var2,sd2,r;
	printf("Enter number of observations :\n");
	scanf("%d",&n);
	printf("Enter the %d ordered pairs of values of the variables \n",n);
	for(i=0;i<n;i++)
	{
	scanf("%lf",&a[i]);
	scanf("%lf",&b[i]);
