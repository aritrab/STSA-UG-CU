#include<stdio.h>
#include<math.h>
/*                       Calculating summary statistics using C                          */
/*Mean, Median, Standard Deviation, Semi-interquartile, Measures of Skeyness and Kurtosis*/
...
/* CALCULATION OF MEAN, VARIANCE, STANDARD DEVIATION */
	...
	var=ssq/n-pow(avg,2);
	sd=pow(var,.5);
	printf("The mean of the dataset is %lf \n",avg);
	printf("The standard deviation of the dataset is %lf \n",sd);
